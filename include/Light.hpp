...
namespace spt
{
    class Light {
        ...
        std::vector<std::pair<Vec3<float>, float>> sampleAll(const std::shared_ptr<BVH>& scene, const Vec3<float>& p) {
        ...
        std::pair<Vec3<float>, float> sample(const std::shared_ptr<BVH>& scene, const Vec3<float>& p) {
